...
def helptranslate():
    helpTranslate =    "╔══[ ร ะ บ บ ป้ อ ง กั น ]" + "\n" + \
                       "╠ เปิดหมด : ป้องกันสมาชิคทั้งหมด" + "\n" + \
                       "╠ ปิดหมด : ไม่ได้ป้องกันสมาชิคในกลุ่ม" + "\n" + \
                       "╠ am : amharic" + "\n" + \
                       "╠ ar : arabic" + "\n" + \
                       "╠ hy : armenian" + "\n" + \
                       "╠ az : azerbaijani" + "\n" + \
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "☞ ŦΣÄM ⚡ชายโอ้⚡ BOT ☜")
